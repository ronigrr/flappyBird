...
bird_upflp = pygame.transform.scale2x(pygame.image.load('assets/redbird-upflap.png').convert_alpha())
bird_frames = [bird_downflap, bird_midflap, bird_upflp]
bird_index = 0
...
def main():
    global game_active, bird_movement, pipe_list, bird_index, bird_surface, bird_rect, score, high_score, score_sound_countdown, floor_x_pos
    while True:
